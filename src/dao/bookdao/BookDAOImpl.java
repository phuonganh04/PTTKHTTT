...
public class BookDAOImpl {
    private final String ADD_BOOK = "insert into book (ISBN, language, title, publicationdate, numberofpage) values (?,?,?,?,?);";
    private static final String DELETE_BOOK = "delete from book where id = ?;";
    private static final String UPDATE_BOOK = "update book set ISBN = ?,language= ?,title =?, publicationdate =?, numberofpage=? where id = ?;";
